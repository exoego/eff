;(() => {
        ...
        <div id="tree">
            <ul>
                <li id="index"><a href="index.html" title="eff">eff</a>
                    <ul>
                        <ul>
                            <li><a href="index.html#contributing" title="貢献">貢献</a>
                    ...
                    <ul>
                                ...
                                <ul>
                                    <ul>
                                        <li><a href="org.atnos.site.Installation.html#additional-dependencies"
                                               title="さらなる依存関係">さらなる依存関係</a>

                                        </li>
                                        <li><a href="org.atnos.site.Installation.html#imports" title="インポート">インポート</a>
                                            <ul>
                                                <li><a href="org.atnos.site.Installation.html#main-types" title="主要な型">主要な型</a>s</a>
                        ...
                        <ul>
                            <li id="org-atnos-site-outofthebox"><a href="org.atnos.site.OutOfTheBox.html"
                                ...
                                <ul>
                                    <ul>
                                        <li><a href="org.atnos.site.OutOfTheBox.html#what’s-next?" title="次にすることは？">次にすることは？</a>
                                ...
                                <ul>
                                    <ul>
                                        <li id="org-atnos-site-lib-evaleffectpage"><a
                                                href="org.atnos.site.lib.EvalEffectPage.html" title="Eval">Eval</a>
                                            <ul></ul>
                                            <ul>
                            ...
                            <li id="org-atnos-site-createeffects"><a href="org.atnos.site.CreateEffects.html"
                                ...
                                <ul>
                                    <ul>
                                        ...
                                        <li><a href="org.atnos.site.CreateEffects.html#interpreter" title="インタープリター">インタープリター</a>
                                ...
                                <ul>
                                    <ul>
                                        ...
                                        <li><a href="org.atnos.site.TransformStack.html#transform-an-effect-to-another"
                                            ...
                                            <ul>
                                                <li><a href="org.atnos.site.TransformStack.html#change-the-effect"
                                                       title="Change the effect">Change the effect</a>
    ...
    window.addEventListener("DOMContentLoaded", function (event) {
        ...
        sidebar.className = "col-md-2 fixed";
        sidebar.innerHTML = sidebarHtml;
        document.querySelector(".sidebar-outer").appendChild(sidebar);

        $('#tree').jstree({
            'core': {
                'initially_open': ['org-atnos-site-outofthebox', 'index', 'org-atnos-site-lib-safeeffectpage'],
                'animation': 200
            },
